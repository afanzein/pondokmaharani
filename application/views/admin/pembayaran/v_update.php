        ...
        <form method="POST" action="<?php echo base_url('pembayaran/pembayaran_update/' . $d['id_pembayaran']); ?>" class="form-horizontal">
          ...
          <div class="card-body">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="total_pembayaran" id="total_pembayaran" value="<?php echo set_value('total_pembayaran', $d['total_pembayaran']); ?>" placeholder="Masukkan Total Pembayaran">
