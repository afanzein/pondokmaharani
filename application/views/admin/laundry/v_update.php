    ...
    <section class="content">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Update Data Laundry</h3>
            </div>
            <div class="card-body">
                <form method="POST" action="<?php echo base_url('laundry/laundry_update/' . $d['id_laundry']); ?>" class="form-horizontal">
                    <div class="card-body">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" name="id_pemesanan" id="id_pemesanan">
                                    <?php foreach ($ddpemesanan as $id => $nik) { ?>
                                        <option value="<?php echo $id; ?>" <?php if ($d['id_pemesanan'] == $id) echo 'selected'; ?>><?php echo $nik; ?></option>
                                    <?php } ?>
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="harga_satuan" id="harga_satuan" placeholder="Masukkan Harga Satuan" value="<?php echo set_value('harga_satuan', $d['harga_satuan']); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="jumlah_laundry" id="jumlah_laundry" placeholder="Masukkan Jumlah Laundry" value="<?php echo set_value('jumlah_laundry', $d['jumlah_laundry']); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="subtotal" id="subtotal" placeholder="Masukkan Subtotal" value="<?php echo set_value('subtotal', $d['subtotal']); ?>">
