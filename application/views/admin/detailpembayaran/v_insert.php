<div class="content-wrapper">
    ...
    <section class="content">
        <div class="card">
            <div class="card-body">
                <form method="POST" action="<?php echo base_url('detailpembayaran/detailpembayaran_insert'); ?>" class="form-horizontal">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" name="id_pembayaran" id="id_pembayaran">
                                    <?php foreach ($ddpembayaran as $id_pembayaran => $tgl_pembayaran) { ?>
                                        <option value="<?php echo $id_pembayaran; ?>"><?php echo $tgl_pembayaran; ?></option>
                                    <?php } ?>
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="item_pembayaran" id="item_pembayaran" placeholder="Masukkan Item Pembayaran">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="jumlah_pembayaran" id="jumlah_pembayaran" placeholder="Masukkan Jumlah Pembayaran">
