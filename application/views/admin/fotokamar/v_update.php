    ...
    <section class="content">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Update Data Foto Kamar</h3>
            </div>
            <div class="card-body">
                <form method="POST" action="<?php echo base_url('fotokamar/fotokamar_update/') . $d['id_foto']; ?>" class="form-horizontal" enctype="multipart/form-data">
                    <div class="card-body">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" name="id_tipe_kamar" id="id_tipe_kamar">
                                    <?php foreach ($ddtipekamar as $id_tipe_kamar => $nama_tipe_kamar) { ?>
                                        <option value="<?php echo $id_tipe_kamar; ?>" <?php echo ($d['id_tipe_kamar'] == $id_tipe_kamar) ? 'selected' : ''; ?>><?php echo $nama_tipe_kamar; ?></option>
                                    <?php } ?>
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" name="deskripsi_foto" id="deskripsi_foto" placeholder="Masukkan Deskripsi Foto"><?php echo $d['deskripsi_foto']; ?></textarea>
