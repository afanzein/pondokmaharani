    ...
    <?php foreach ($pembayaran as $p) : ?>
        <div class="pembayaran">
            ...
            <div class="payment-instructions">
                ...
                <p class="contact-info">Jika Anda memerlukan bantuan tambahan atau memiliki pertanyaan, jangan ragu untuk menghubungi kami melalui <a aria-label="Chat on WhatsApp" href="https://wa.me/08115018800"><img alt="Chat on WhatsApp" src="WhatsAppButtonGreenLarge.png" />
<a /> atau <strong>pondokmaharanibjm8@gmail.com</strong>.</p>
