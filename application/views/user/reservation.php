            ...
            <div class="col-md-6"> 
                ...
                <form method="post" action="<?php echo base_url('reservation/pesan_submit'); ?> ">
                    <div class="detail-text">
                        ...
                        <label class="col-sm-6"><b>Total Hari   : </b> <input type="text" class="col-sm-4" id="totalDays" readonly></b></label>
                        <label class="col-sm-6"><b>Total Biaya    : </b> <input type="text" class="col-sm-4" id="totalPayment" readonly></b></label>
                    </div>
